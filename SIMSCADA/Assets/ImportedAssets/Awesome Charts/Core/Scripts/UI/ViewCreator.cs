...
namespace AwesomeCharts {
    public class ViewCreator : Object {
        ...
        //}
        public TextMeshProUGUI InstantiateBottomLabel(string name, Transform parent, Vector2 pivot, TMP_FontAsset labelFont)
        {
            TextMeshProUGUI label = CreateBaseGameObject(name, parent, pivot).AddComponent<TextMeshProUGUI>();
