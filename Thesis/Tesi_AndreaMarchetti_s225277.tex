...
\titolo{SimSCADA, un security serious game per gli ambienti SCADA}% per la laurea quinquennale e il dottorato
...
\input{Capitoli/2_serious_games.tex}

\chapter{Sistemi SCADA}

\input{Capitoli/3_sistemi_scada.tex}

\chapter{Analisi dei rischi in un sistema SCADA}

\input{Capitoli/4_sicurezza_scada.tex}

\chapter{SimSCADA: design e implementazione}

\input{Capitoli/5_design_progetto.tex}

\chapter{Manuale del programmatore}

\input{Capitoli/6_manuale_programmatore.tex}

\chapter{Risultati}

\input{Capitoli/7_risultati.tex}

\chapter{Conclusioni}

\input{Capitoli/8_conclusioni.tex}
...
\chapter{Manuale d'installazione}\label{sec:howto}

\input{Capitoli/appendix_manuale_installazione.tex}

\chapter{Questionario di valutazione}\label{sec:questions}

\input{Capitoli/appendix_quiz.tex}

%\chapter{Risposte al quiz}\label{sec:answers}
%
%\input{Capitoli/appendix_risposte.tex}
